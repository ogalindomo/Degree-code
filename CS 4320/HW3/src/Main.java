...
public class Main {
  public static void main(String[] args) {
    ...
    if (algorithm == 0) {
      ...
      solution = search.solveAnnealing(test1, deadline);
      baseline = test1.evaluateSchedule(search.naiveBaseline(test1, 10000));
    }
    else if(algorithm == 2){
    ...
    System.out.println("Improvement: "+(score-baseline));
    System.out.println();
  }
}
