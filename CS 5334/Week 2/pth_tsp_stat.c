 ...
 *
 * Compile:  gcc -g -Wall -o pth_tsp_stat pth_tsp_stat.c -lpthread
 *           Needs timer.h
 * Usage:    pth_tsp_stat <thread count> <matrix_file>
 *
 ...
 *     digraph[i*n + j]
 *
 * IPP:  Section 6.2.6 (pp. 309 and ff.)
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
 ...
 * 2. Need the extra check of Best_tour in case another thread
