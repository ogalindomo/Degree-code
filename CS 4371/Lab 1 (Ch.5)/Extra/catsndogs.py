...
##########################################################################################
    ...
    (train_dir, validation_dir, test_dir) = make_directories(base_dir, original_dataset_dir)
    (train_cats, train_dogs, validation_cats, validation_dogs, test_cats, test_dogs) = catndogs_dir(train_dir, validation_dir, test_dir)
    import_images_cats()
    import_images_dogs()