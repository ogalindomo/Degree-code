...
public class Board
{
  private static boolean board[][] = new boolean [15][15];
  private static boolean boardRed[][] = new boolean [15][15];
  private static boolean boardBlue[][] = new boolean [15][15];
  ...
  public static boolean redUse (int xcoord, int ycoord)
  {
     if(boardRed[ycoord][xcoord] == true)
        return true;
     return false;
  }
  
  public static boolean blueUse (int xcoord, int ycoord)
  {
     if(boardBlue[ycoord][xcoord] == true)
        return true;
     return false;
  }
}
