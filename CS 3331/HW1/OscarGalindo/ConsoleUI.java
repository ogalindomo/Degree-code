      ...
      for(int i = 0, rowNum = 1; i < 31; i++)
      {
        ...
        else
        {
          ...
          for(int j = 0; j < 15; j++)
          {
            System.out.print("|");  
            System.out.print(" ");
            if(Board.boardRed[rowNum - 1][j])//This line checks if the space was already selected by a player and prints out, if selected, the sign of each player.
              System.out.print("•");
            else if(Board.boardBlue[rowNum - 1][j])
              System.out.print("○");
