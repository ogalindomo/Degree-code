...
public class DifficultAI implements AI
{
     ...
     */
    public DifficultAI (Board board)
    {
        this.board = board;
        highestInChunk = 0;
    }
    ...
    { 
        possibleFive(aiArr, playerArr); //Checks if the priority of the AI is to attack.
        if(highestInChunk > 2)//Threshold set at 2, that is, the AI attacks if it has at least 2 connected disks than can create a connect five.
            setCoordinates(aiArr);
            
        else if(possibleFive(playerArr,aiArr)) //Checks whether if the player has option of winning and if so it blocks said option.
