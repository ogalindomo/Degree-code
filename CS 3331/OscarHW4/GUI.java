...
public class GUI extends JFrame implements ActionListener
{
    ...
    private static JMenuItem fifteen, twelve, nine, muted, color, aiEasy, aiMedium, aiDifficult, single, multi;
    ...
    void changeColor()
    {
        ...
        if(new Main().getPlay())
        {
            String inputColor = "";
            int r = 0, g = 0, b = 0;
            if(colorPlayer1.equals("Orange") && colorPlayer2.equals("Blue"))
