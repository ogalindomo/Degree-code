...
public class Main  extends MouseAdapter
{
    ...
    public static void play()
    {
        ...
        else
        {
            ...
            {
               screen.setMessage("Congratulations Player 1, you won!");
               playing = false;
            }
            else if(status == 4)
            {
               if(artificialActive) //Differentiated message in case the AI won.
                   ...
                   screen.setMessage("Congratulations Player 2, you won!");
               playing = false;
            }
            else if(status == 0)
            {
               ...
               {
                   screen.setMessage("Player 1 please choose a new position!");
               }
               else if(!artificialActive)
               {
                   screen.setMessage("Player 2 please choose a new position!");
               }
            }
        }
    }
    ...
    /** 
     * Communicates to the solicitor if the game is in progress.
     * @return boolean playing (indicating if the game is in progress).
     */
    public boolean getPlay(){return playing;}
}
